...
def parse_train_args():
    ...
    # Guidance: Seems like its only for enhancer design
    ...
    parser.add_argument("--mode", choices=['distill', 'dirichlet', 'riemannian', 'mlm', 'ardm', 'lrar', 'cdcd', 'ppl_eval','sfm','fisher'], default='dirichlet')
