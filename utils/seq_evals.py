...
"""
This draft is originally copied from:
https://github.com/anirbansarkar-cs/D3-DNA-Discrete-Diffusion/blob/main/Evaluation/seq_evals.py#L467
"""
...
def predictive_distribution_shift(activity1, activity2):
    
    ks_stat, p_value = ks_2samp(activity1, activity2)
